...
function HomePage() {
  let getUser = () => {
    try {
      let token = jwt_decode(localStorage.getItem("user"));
      return token;
    } catch (error) {
      return null;
    }
  ...
  let [userName, setUserName] = useState(getUser());
              ...
              <ul className="navbar-nav  mb-2 mr-auto mb-lg-0 ms-3">
                ...
                <li className="nav-item">
                  {userName == null ? (
                    ...
                    <>
                      <span class="text-white">Welcome, {userName.name}</span>
                      <a
                        onClick={logout}
                        className="btn bg-danger  px-3 rounded"
                      >
                        Logout
                      </a>
                    </>
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="loginModelLabel">
                Login
              </h5>
            ...
            <div className="modal-body">
              <center>
                <GoogleOAuthProvider clientId="1027468996731-jh7p56o5m8csprq1l6hrqe0e7pv6bl4a.apps.googleusercontent.com">
                  <GoogleLogin
                    onSuccess={onSubmit}
                    onError={() => {
